...
namespace BatchDotnetTutorialFfmpeg
{
    ...
    public class Program
    {
        ...
        private const string BatchAccountName = "badribatch";
        private const string BatchAccountKey = "LwuPIx7uU99JW0H2RuyhyO+KazbV8zm0zrtaOi0QT8H1LcS+pEObpsImHyG1pmxqAl2uUI5Tkh5BtWujDT6Emw==";
        private const string BatchAccountUrl = "https://badribatch.eastus.batch.azure.com";

        // Storage account credentials
        private const string StorageAccountName = "badribatchstorage";
        private const string StorageAccountKey = "UyCFODb5fYJW6YnC+fiaY+LrycoSjgmAEEqDuHgIgIPtzqdI+kvSuRZ5pgraFM5dK3R0WriU+y7fx7Q0j2CKMQ==";
